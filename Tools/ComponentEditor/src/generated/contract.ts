...
export const MIN_EDITOR_REVISION = 0;
export const FIRST_STYLE_CHANGE_REVISION = 1;
export const MAX_EDITOR_REVISION = 1000000000;
export const EDITOR_SOURCE = "component-editor";
...
export const NUMBER_COMMA_STYLE_VALUES = ["default","round","square"] as const;
export type ChartNumberCommaStyle = (typeof NUMBER_COMMA_STYLE_VALUES)[number];

export const NUMBER_ANIMATION_EASING_VALUES = ["snappy","linear","easeIn","easeOut","easeInOut"] as const;
export type ChartNumberAnimationEasing = (typeof NUMBER_ANIMATION_EASING_VALUES)[number];
...
export interface NumberStyle {
  ...
  openFour: boolean;
  openSix: boolean;
  flatTopThree: boolean;
  animationDuration: number;
  animationEasing: ChartNumberAnimationEasing;
}

export const NUMBER_STYLE_DEFAULT: NumberStyle = {
  color: "#262626",
  fontSize: 48,
  fontWeight: 280,
  opticalSize: 32,
...
export const NUMBER_STYLE_RANGES = {
...
export function isNumberStyle(value: unknown): value is NumberStyle {
  if (!isRecord(value)) {
    return false;
  }
  return (
    isChartColor(value.color) &&
    isNumberInRange(value.fontSize, 24, 72) &&
    isNumberInRange(value.fontWeight, 100, 900) &&
    isNumberInRange(value.opticalSize, 14, 32) &&
    isNumberInRange(value.tracking, -2, 2) &&
    isOneOf(value.commaStyle, NUMBER_COMMA_STYLE_VALUES) &&
    typeof value.slashedZero === "boolean" &&
    typeof value.openFour === "boolean" &&
    typeof value.openSix === "boolean" &&
    typeof value.flatTopThree === "boolean" &&
    isNumberInRange(value.animationDuration, 0.1, 2) &&
    isOneOf(value.animationEasing, NUMBER_ANIMATION_EASING_VALUES)
  );
}
